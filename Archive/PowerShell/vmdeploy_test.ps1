...
#----------------------- ServiceNow Input -----------------------# 
$myVmname = "nstest203-new"
$snIPAddress = "156.45.55.60"
$snServerType = "SQL"          		    #"Wap,Web,SQL,FTP,Print,DC,Other"
$snOSVersion = "Windows 2012R2"         #"Windows 2008R2,Windows 2012,Windows 2012R2,HP-UX,Linux,Solaris"
$snRAM = 8
$snCPU = 4
...
#----------------------- Changing Primary Function to Server Type: $myCluster -----------------------# 
...
start-Sleep -Seconds 540 #( aka 9 minutes)
